...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '李书中', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '李书中的成长记录', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lishuzhong.us.kg', // 网站地址
